...
src/lib/actions/                Server Actions (marcar completado, comentar)
...
Ya funciona (una vez conectada la base de datos y Clerk): auth + creación de equipo vía Clerk Organizations, sincronización de usuarios/equipos por webhook, dashboard de coach y atleta con las 4 métricas, calendario semanal de solo lectura, detalle de entrenamiento con feedback manual del atleta y comentarios del coach, perfil de atleta con historial.

Pendiente inmediato (ver Paso 8 del spec, "Must have" restante y "Should have"): formulario de creación de plantillas/entrenamientos con editor de segmentos, asignación al calendario desde la UI (hoy solo se puede sembrar vía Prisma Studio/seed), y mover/copiar/duplicar entrenamientos por drag-and-drop.
