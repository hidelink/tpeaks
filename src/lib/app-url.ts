 ...
 *
 * Sin esto, la invitación no dice a dónde volver y Clerk manda a su propia
 * página de bienvenida ("You are signed in. Now, it's time to connect Clerk to
 * your application"), que para quien acaba de aceptar una invitación a un club
 * no significa nada.
 *
 ...
 *    Vercel inyecta solo. Sirve para no tener que configurar nada, pero puede
 *    no ser el alias bonito.
