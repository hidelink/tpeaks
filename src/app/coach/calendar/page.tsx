...
/**
 * Vista semanal de solo lectura. Crear/editar/mover/copiar/duplicar
 * entrenamientos (drag-and-drop) es "should have" — ver docs/PRODUCT_SPEC.md,
 * Paso 8 — y se construye en la siguiente iteración sobre esta base.
 */
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-zinc-500">
          Crear entrenamientos: próximamente en esta vista.
        </span>
      </div>
