    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link href={`/athlete/calendar?week=${previous}`} className="text-sm underline">
            ← Anterior
          </Link>
          <Link href="/athlete/calendar" className="text-sm underline">
            Hoy
          </Link>
          <Link href={`/athlete/calendar?week=${next}`} className="text-sm underline">
            Siguiente →
          </Link>
        </div>
      </div>
